  ...
  return (
    <div>
          ...
          <>
            <div class="columns is-tablet dataFields ">
              <div class="column is-5">
                ...
                <p class="bold bold" style={{ color: "#b5b5b5" }}>
                  {data.description}
                </p>
              </div>
              <div class="column " style={{ position: "relative" }}>
                {data.fields.map((input, index) => {
                  return (
                    <>
                      {input.map((input, fieldi) => {
                        return (
                          <div className="padding15">
                            <p className="font20 marginBottom5">
                              {input.name.replaceAll("-", " ").toUpperCase()}
                            </p>
                      ...
                      <div
                        class="columns is-mobile padding15"
                        style={{ height: "70px" }}
                      >
                        <p class="column">
                          {data.fields.length > 1 ? (
                            <a
                              ...
                              onClick={() => {
                                deleteData(datai, index);
                              }}
                              class="button addAnotherbtn is-danger noborder"
                            >
                              delete
                            </a>
                          ) : null}
                ...
                >
                  {!data.unique ? (
                    <button
                      onClick={() => {
                        createAnother(datai, data);
                      }}
                      class="button animatex addAnotherbtn"
                    >
                      Add Another
                    </button>
                  ) : null}
      ...
      <p class="column center">
        ...
        <button
          onClick={() => {
            window.open("").document.write(Template(structure));
          }}
          class="button animatex addAnotherbtn margin5"
        >
          Download
        </button>
      </p>
