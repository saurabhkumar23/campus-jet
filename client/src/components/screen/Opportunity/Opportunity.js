        ...
        .then((result) => {
          if (result?.error) {
            ...
            if (result?.createdDate) {
              ...
              result.createdDate =
                dateArr[0] + ", " + month[dateArr[1]] + " " + dateArr[2];
            }
            if (result?.interviewDate) {
                console.log(result);
                let date = result.interviewDate.split(" ")[0];
                console.log(date);
              ...
              if (result?.resultDate) {
                console.log(result);
                let date = result.resultDate.split(" ")[0];
                console.log(date);
                    ...
                    <div className="head">
                      ...
                      <div>
                        {isAdmin ? (
                          <Link
                            className="edit-link"
                            to={`/admin/editOpportunity/${data.id}`}
                          >
    ...
    <div class="info">
        ...
        <p>{data.resultDate}</p>
                    ...
                    <div onClick={() => setIsOtpNeeded(true)}>
                      <a
                        class="apply-link btn waves-effect waves-light"
                        target="_blank"
                        href={data.applyLink}
                      >
                        Apply Now
